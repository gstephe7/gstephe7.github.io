...
var projects = {
  title: 'PROJECTS',
  projectsList: [
    { name: 'Handrail Helper', img: 'img/project-handrailhelper.jpg', alt: 'Handrail Helper App', href: 'https://handrailhelper.com', description: 'Steel handrail builders spend a large amount of time manually calculating the angles at which pieces need to be cut. Shop drawings only display an overall "rise over run" pitch, and do not include angles for cuts, so I developed a simple app that calculates the angle of each cut. This app cuts down on non-value-added-time and allows handrail builders to spend more of their time actually building. JavaScript, HTML5, CSS3, and Bootstrap were used.' },
